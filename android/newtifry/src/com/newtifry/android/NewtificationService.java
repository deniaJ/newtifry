...
public class NewtificationService extends Service
{
	...
	public Notification setLatestEventInfo( NewtifrySource source, NewtifryMessage message )
	{
		...
		unreadMessagesOfType = NewtifryMessage.FACTORY.countUnread(this, source);
	...
	public void onStart( Intent intent, int startId )
	{
		...
		{
			Log.d(TAG, "Newtification Service received newtifry command.");
	...
	private void updateNotificationFor( NewtifrySource source )
	{
		if( NewtifryMessage.FACTORY.countUnread(this, source) == 0 )
		{

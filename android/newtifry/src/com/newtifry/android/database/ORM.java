...
public abstract class ORM<T>
{
	...
	public void save( Context context )
	{
		...
		else
		{
			// Update.
			ContentValues values = this.flatten();
			context.getContentResolver().update(this.getItemUri(), values, NewtifryDatabaseAdapter.KEY_ID + "=" + this.getId(), null);
		}
	}
	...
	{
		context.getContentResolver().delete(this.getItemUri(), NewtifryDatabaseAdapter.KEY_ID + "=" + this.getId(), null);
	}
	...
	{
		context.getContentResolver().delete(this.getItemUri(), NewtifryDatabaseAdapter.KEY_ID + "=" + id, null);
	}
	...
	{
		return this.getOne(context, NewtifryDatabaseAdapter.KEY_ID + "=" + id, null);
	}

...
public class NewtifryDatabaseAdapter extends ContentProvider
{
	public static final String PROVIDER_NAME_ACCOUNTS = "com.newtifry.android.provider.NewtifryAccounts";
	public static final String PROVIDER_NAME_SOURCES = "com.newtifry.android.provider.NewtifrySources";
	public static final String PROVIDER_NAME_MESSAGES = "com.newtifry.android.provider.NewtifryMessages";
	...
	private static final String DATABASE_NAME = "newtifry";
	...
	public String getType( Uri uri )
	{
		switch( uriMatcher.match(uri) )
		{
			// Get all accounts.
			case ACCOUNTS:
				return "vnd.android.cursor.dir/vnd.newtifry.accounts";
			// Get a single account.
			case ACCOUNT_ID:
				return "vnd.android.cursor.item/vnd.newtifry.accounts";
			// Get all accounts.
			case SOURCES:
				return "vnd.android.cursor.dir/vnd.newtifry.sources";
			// Get a single account.
			case SOURCE_ID:
				return "vnd.android.cursor.item/vnd.newtifry.sources";
				// Get all accounts.
			case MESSAGES:
				return "vnd.android.cursor.dir/vnd.newtifry.messages";
			// Get a single account.
			case MESSAGE_ID:
				return "vnd.android.cursor.item/vnd.newtifry.messages";				
			default:

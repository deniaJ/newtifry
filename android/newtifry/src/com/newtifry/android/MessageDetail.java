...
public class MessageDetail extends SherlockActivity
{
	...
	private NewtifryMessage message = null;
	 ...
	 * @param message
	 */
	public void loadFromMessage( NewtifryMessage message )
	{
	...
	public NewtifryMessage getMessage()
	{
		if( this.message == null )
		{
			...
			this.message = NewtifryMessage.FACTORY.get(this, sourceIntent.getLongExtra("messageId", 0));

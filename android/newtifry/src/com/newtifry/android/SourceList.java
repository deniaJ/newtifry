...
public class SourceList extends SherlockListActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener
{
	...
	public void refreshView()
	{
		...
		ArrayList<NewtifrySource> sources = NewtifrySource.FACTORY.listAll(this, this.getAccount().getAccountName()); 
	 ...
	 * @param account
	 */
	public void clickSource( NewtifrySource source )
	{
	 ...
	 * @param state
	 */
	public void checkedSource( NewtifrySource source, boolean state )
	{
		// All we're doing is changing the LOCAL enable flag.
		// Refresh the source.
		NewtifrySource refreshedSource = NewtifrySource.FACTORY.get(this, source.getId()); 
			...
			else
			{
				try
				{
					...
					else if( operation.equals("list") )
					{
						...
						NewtifrySource.FACTORY.syncFromJSONArray(thisActivity, serverList, thisActivity.getAccount().getAccountName());
						
						// Mark the account as synced.
						NewtifryAccount account = NewtifryAccount.FACTORY.getByAccountName(thisActivity, thisActivity.getAccount().getAccountName()); 
	 ...
	 * @author daniel
	 */
	private class SourceArrayAdapter extends ArrayAdapter<NewtifrySource>
	{
		final private SourceList parentActivity;
		private ArrayList<NewtifrySource> sources;

		public SourceArrayAdapter( SourceList parentActivity, Context context, int textViewResourceId, ArrayList<NewtifrySource> objects )
		{
		...
		public View getView( int position, View convertView, ViewGroup parent )
		{
			...
			// Find the account.
			final NewtifrySource source = this.sources.get(position);

...
public class HealthCheck
{
	...
	public static HealthCheck performHealthcheck( Context context )
	{
		...
		ArrayList<NewtifryAccount> accounts = NewtifryAccount.FACTORY.listAll(context);
		...
		for( NewtifryAccount account: accounts )
		{
			...
			{
				hasBackend = true;
				ArrayList<NewtifrySource> sources = NewtifrySource.FACTORY.listAll(context, account.getAccountName());

...
{	
	...
	public void onCreate( Bundle savedInstanceState )
	{
	    ...
	    GCMRegistrar.checkManifest(this);		// Register for C2DM. We'll report this to the server later.
		final String registrationId = GCMRegistrar.getRegistrationId(this);
		if( registrationId != null && !"".equals(registrationId) )
		{
			Log.i("Newtifry", "Already registered. registrationId is " + registrationId);
		}
		else
		{
			Log.i("Newtifry", "No existing registrationId. Registering.");
		...
		NewtifryMessage.FACTORY.deleteOlderThan(this, olderThan);
	}
	...
	public void onResume()
	{
		...
		{
			Log.d("Newtifry", "Can't find own installed package...");
		}
	}
	...
	private final BroadcastReceiver healthCheckReciever = new BroadcastReceiver()
	{
		...
		{
			Log.d("Newtifry", "Re-performing health check.");
			try
			{
				doHealthCheck();
			}
			...
			{
				Log.d("Newtifry", "Can't find own package information...");
			}
		}
	};	
}
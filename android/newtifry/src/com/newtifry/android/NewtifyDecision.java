...
public class NewtifyDecision
{
	private Boolean shouldNotify;
	private NewtifryMessage message;
	...
	public NewtifryMessage getMessage()
	{
		return message;
	}

	public void setMessage( NewtifryMessage message )
	{
	 ...
	 * @return
	 */
	public static NewtifyDecision shouldNotify( Context context, NewtifryMessage message )
	{
		NewtifyDecision decision = new NewtifyDecision();
